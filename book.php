...
<div class="subtitle"><?=preg_replace("/(\d+)(\d\d\d)/","$1,$2",$wordcount)?> words of fictional card games autogenerated for NaNoGenMo 2019 from a script written by <a href="http://kevan.org">Kevan Davis</a>.<br>
